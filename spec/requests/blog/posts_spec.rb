...
RSpec.describe "/blog/posts", type: :request do
  ...
  describe "GET /index" do
    it "renders a successful response" do
      Blog::Post.create! valid_attributes
      get blog_posts_url
  ...
  describe "POST /create" do
    context "with valid parameters" do
      ...
      it "redirects to the created blog_post" do
        post blog_posts_url, params: { blog_post: valid_attributes }
        expect(response).to redirect_to(blog_post_url(Blog::Post.last))
      end
    end
    ...
    context "with invalid parameters" do
      it "does not create a new Blog::Post" do
        ...
        }.to change(Blog::Post, :count).by(0)
      end
  ...
  describe "PATCH /update" do
    context "with valid parameters" do
      ...
      it "updates the requested blog_post" do
        post = Blog::Post.create! valid_attributes
        patch blog_post_url(post), params: { blog_post: new_attributes }
        post.reload
      ...
      it "redirects to the blog_post" do
        ...
        patch blog_post_url(post), params: { blog_post: new_attributes }
        post.reload
        expect(response).to redirect_to(blog_post_url(post))
      end
    end
    ...
    context "with invalid parameters" do
      ...
      it "renders a response with 422 status (i.e. to display the 'edit' template)" do
        post = Blog::Post.create! valid_attributes
        patch blog_post_url(post), params: { blog_post: invalid_attributes }
        expect(response).to have_http_status(:unprocessable_entity)
      end
