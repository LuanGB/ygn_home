...
ActiveRecord::Schema[7.1].define(version: 2024_02_29_162715) do
  ...
  create_table "blog_comments", force: :cascade do |t|
    ...
    t.index ["resource_type", "resource_id"], name: "index_blog_comments_on_resource"
  end
  ...
  create_table "urids", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["resource_type", "resource_id"], name: "index_urids_on_resource"
  end
